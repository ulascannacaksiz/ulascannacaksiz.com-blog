...
<?php
	...
	$query=$db->prepare("SELECT yazi,yid,sef,baslik,kategori_id,resimler.yazi_id,resimler.kapak,resimler.url from yazilar  INNER JOIN resimler on resimler.yazi_id=yazilar.yid WHERE kapak = 1 and baslik  like '%$gelen_deger%' ||  yazi like '%$gelen_deger%'");
	$query->execute();
